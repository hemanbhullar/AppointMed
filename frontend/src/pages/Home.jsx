    ...
    <div className="container">
      ...
      <div>
        <div className="lg:w-[570px]">
          ...
          Natus quaerat camque fugit, perspiciatis cum nemo aperiam, aut quia earum amet architecto, modi adio. Soluta unde ducimus perferendis?</p>
      ...
      <div className="container">
        ...
        <div className="py-[30px] px-5 ">
          ...
          <div className="mt-[30px]">
            ...
            <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">world-class care for everyone. Our health System offers unmathced, expert health care. From the lab to the clinic.
            </p>

            <Link 
            to="/doctors" className="w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center justify-center group hover:bg-blue-500 hover:border-none">
        ...
        <div className="py-[30px] px-5 ">
          ...
          <div className="mt-[30px]">
            ...
            <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">world-class care for everyone. Our health S ystem offers unmathced, expert health care. From the lab to the clinic.
            </p>
        ...
        <div className="py-[30px] px-5 ">
          ...
          <div className="mt-[30px]">
            ...
            <Link 
            to="/doctors" className="w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center justify-center group hover:bg-primaryColor
            hover:border-none">
              <BsArrowRight className="group-hover:text-white w-6 h-5" /> 
            </Link>
          </div>
