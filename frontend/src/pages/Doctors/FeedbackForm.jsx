...
const FeedbackForm = () => {
    ...
    return <form action="">
        ...
        <textarea className='border border-solid border-[#0066ff34] focus:outline outline-[#3b82f6] w-full px-4 py-3 rounded-md' rows="5" placeholder="Write your message" onChange={()=>setReviewText(e.target.value)}>
        </textarea>
        </div>
