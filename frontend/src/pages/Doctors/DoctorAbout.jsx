  ...
  return (
    <div>
        <div>
            ...
            <p className="text__para">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maiores voluptatem ipsa veniam temporibus mollitia perspiciatis eaque itaque, sint perferendis, magnam id rem aliquam earum quam. Qui sunt corporis, dolorum eos impedit ea officia optio porro minus, quasi minima eaque possimus illum itaque nemo rerum est! Dolorum voluptates dolor alias voluptatum!
            </p>
        </div>
        <div className='mt-12'>
